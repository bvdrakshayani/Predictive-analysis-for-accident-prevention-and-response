...
def main():
    ...
    if submit:
          ...
          if prediction == 0:
                 st.subheader(f"The severity prediction is Fatal Injury⚠")
          elif prediction == 1:
                 st.subheader(f"The severity prediction is serious injury")
          else:
                 st.subheader(f"The severity prediction is slight injury")
